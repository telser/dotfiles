...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rainbow-mode org org-agenda-property org-alert org-beautify-theme org-caldav org-dashboard flycheck-yamllint flymake-yaml indent-tools yaml-mode company-ghci sr-speedbar smex workgroups2 persp-mode ace-window ace-jump-buffer ace-jump-mode window-jump buffer-move yasnippet undo-tree flycheck-haskell rainbow-delimiters paredit-menu paredit lusty-explorer flycheck diminish change-inner ag projectile)))
