...
;; ; old custom var '(hindent-style "chris-done")
...
;; (define-key ghci-script-mode-map (kbd "C-c C-c") 'haskell-process-stack-build)
;; (define-key ghci-script-mode-map (kbd "C-c c") 'haskell-process-stack)
...
;; (define-key haskell-cabal-mode-map (kbd "C-c C-c") 'haskell-process-stack-build)
;; (define-key haskell-cabal-mode-map (kbd "C-c c") 'haskell-process-stack)
...
;; (define-key haskell-interactive-mode-map (kbd "C-c c") 'haskell-process-stack)
...
;;;; Cruft, was probably used at some point, but not currently
