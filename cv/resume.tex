...
\begin{position}
  ...
  Minor development used Haskell, with operation support using Python and Ruby.
  Developer reporting directly to the CTO and CEO with resposiblities for new
  features, maintence, testing, and deployment. Products
  include an Erlang and Javascript based website application and distributed event
  driven system, with RESTful services to an Angular display that is fed data from
  the Erlang system, as well as outside sources.
