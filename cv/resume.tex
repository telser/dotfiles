...
\begin{position}
  Polyglot software development mainly with Clojure, Erlang, Fay,
  Haskell and Javascript.
  Operation support using Python.
 ...
 Angular, Cabal, Elasticsearch, FreeBSD, Git, Leiningen, PostgreSQL, RabbitMQ,
...
Programming Languages (novice): C, Elm, Erlang, Fay, Javascript, Python, R, Ruby
