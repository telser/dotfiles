...
\begin{position}
  Polyglot software development in Clojure, Haskell, Javascript,
  and Python. Part of a small team where resposiblities for new
  ...
  A rewrite from scratch to be complementary to the new product has begun.
  Replacement services are being written in Python and Haskell.
 ...
 Angular, Cabal, Core.Typed, Django, Elastic Search, Git, JIRA,
 PostgreSQL, RabbitMQ, Selenium, SQLite3.
\end{position}
...
Other techonolgy tools I use/prefer include: Cabal, Emacs, Git, Leiningen, Mosh
