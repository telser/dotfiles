...
Programming Languages (minor experience): C, Elm, Go, Python, R

Programming Languages (interested in, but have not used): Factor, Forth,
Julia, Mercury, OpenCL, Prolog, Rust

Markup Languages: LaTeX, Org-mode

Operating systems(Preferred): FreeBSD, illumos (various distributions), OpenBSD

Operating sytems(comfortable using):
DragonflyBSD, Linux (various distributions), NetBSD and Solaris
